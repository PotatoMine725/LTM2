...
public class ChatClient {
    ...
    public synchronized void connect(String host, int port) {
        ...
        try {
            ...
            statusConsumer.accept("Connect failed: " + ex.getMessage());
        }
    }
    ...
    public synchronized boolean login(String username, String password) {
        return sendAuthCommand(AccountProtocol.LOGIN, username, password);
    }
    ...
    public synchronized void logout() {
        ...
        try {
            ...
            output.flush();
            statusConsumer.accept("Logged out");
        } catch (IOException ex) {
            statusConsumer.accept("Logout failed: " + ex.getMessage());
        }
    }
    ...
    public synchronized void sendText(String message) {
        ...
        try {
            ...
            statusConsumer.accept("Send text failed: " + ex.getMessage());
        }
    }
    ...
    public synchronized void sendImage(File file) {
        ...
        try (FileInputStream inputStream = new FileInputStream(file)) {
            ...
            statusConsumer.accept("Send image failed: " + ex.getMessage());
        }
    }
    ...
    private boolean sendAuthCommand(String command, String username, String password) {
        ...
        try {
            ...
            statusConsumer.accept("Auth failed: " + ex.getMessage());
            return false;
        }
    }
    ...
    private void listenLoop() {
        try {
            ...
            if (connected) {
                statusConsumer.accept("Connection lost: " + ex.getMessage());
            }
        } finally {
            closeResources();
        }
